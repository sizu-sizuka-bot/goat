...
module.exports = {
  config: {
    ...
    version: "2.0-usersData-fixed",
    author: "farhan",
    countDown: 15,
    role: 0,
    description: { en: "Balance leaderboard with usersData system" },
    category: "Game",
  ...
  onStart: async function ({ api, event, args, message, usersData }) {
    ...
    for (const uid of members) {
      ...
      // ✅ USERSDATA MONEY SYSTEM (ONLY CHANGE)
    ...
    const getAvatar = async (uid) => {
      try {
        ...
        return await loadImage("https://i.imgur.com/2nCt3Sbl.png");
      }
    };
    ...
    ctx.font = "28px Arial";
    ctx.fillText(`Page ${page} • Reply with page number`, 600, 1630);
