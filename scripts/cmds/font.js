module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    // PREVIEW WITH NAME LOCK
    const preview = (arr) => {

      if (ORIGINAL_NAME !== "Farhan") {
        return "⚠️ Name Lock Enabled";
      }
...
╚━━━━━━━━━━━━━━━━━━╝`,
    ...
    if (!type || !text) {
      return api.sendMessage(
        "Use: font list OR font 1 Farhan",
        event.threadID
      );
    }
    ...
    if (!selected) {
      return api.sendMessage(
        "Invalid font type! Use: font list",
        event.threadID
      );
    }
