...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    const admins = [
      { uid: "61560833120754", names: ["M'ʀ Fʌʀʜʌŋ"] },
    ...
    const captions = [
      ...
      "👉আমার বস ♻️ 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://www.facebook.com/61560833120754 🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜🐒",
